...
public class ReplyController {
    ...
    @ResponseBody
    public Map<String, Object> add(@RequestBody Reply reply) throws Exception {
    ...
    @ResponseBody
    public Map<String, Object> list(@RequestBody Map<String,Integer> param)throws Exception {
        int id = param.get("id");
